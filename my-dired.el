...
(defun my-dired-sandbox (which-sandbox)
  ...
  (let ((sandbox (cond
                  ((= which-sandbox ?1) '("~/ws/ndiags1/src"  "diags1-src"))
                  ((= which-sandbox ?2) '("~/ws/ndiags2/src"  "diags2-src"))
                  ((= which-sandbox ?3) '("~/ws/ndiags3/src"  "diags3-src"))
                  ((= which-sandbox ?4) '("~/ws/nconapp1/src" "conapp1-src"))
                  ((= which-sandbox ?5) '("~/ws/nconapp2/src" "conapp2-src"))
                  ((= which-sandbox ?6) '("~/ws/nconapp3/src" "conapp3-src"))
