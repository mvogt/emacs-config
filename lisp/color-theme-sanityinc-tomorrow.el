...
(defconst color-theme-sanityinc-tomorrow-colors
  '((night . ((background . "#262626")
              (alt-background . "#2ba22ba42ba7")
              (current-line . "#2e2e2e")
              (selection . "#3A3A3A")
              (foreground . "#B2B2B2")
              (comment . "#848484")
  ...
  (quote
   (mapcar
    ...
    `(;; Standard font lock faces
      ...
      (font-lock-doc-face (:foreground ,orange))
      (font-lock-doc-string-face (:foreground ,yellow))
      (font-lock-function-name-face (:foreground ,purple))
      ...
      (dired-executable (:foreground ,aqua))
      (dired-symlink (:foreground ,purple))
      (dired-perm-write (:foreground ,yellow))
      (dired-special (:foreground ,green))
      ...
      (helm-ff-file (:foreground ,foreground))
      (helm-ff-file-extension (:weight bold))
      ...
      (helm-ff-executable (:foreground ,aqua))
      (helm-ff-symlink (:foreground ,foreground))
      (helm-ff-truename (:foreground ,foreground))
      ...
      (helm-selection (:inherit highlight :extend t :distant-foreground ,yellow))
      (helm-selection-line (:inherit highlight :extend t :distant-foreground ,yellow))
